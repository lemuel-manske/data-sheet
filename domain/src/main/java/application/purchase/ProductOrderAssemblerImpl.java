...
@Component
public class ProductOrderAssemblerImpl implements ProductOrderAssembler {

    private final CalculatePurchaseTotalService calculatePurchaseTotalService;

    @Autowired
    public ProductOrderAssemblerImpl(CalculatePurchaseTotalService calculatePurchaseTotalService) {
